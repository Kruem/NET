<%@ Page Title="" Language="C#" MasterPageFile="~/master/Moderador.Master" AutoEventWireup="true" CodeBehind="ClaComuNegocio.aspx.cs" Inherits="testBancolombia.THumanoFrm.ClaComuNegocio" %>
    ...
    <div class="container-fluid backg" id="page-top">
        <form runat="server" class="form-horizontal">
            <div class="col-md-12">
                ...
                <img src="../images/claridadComunic.png" class="" width="9%" />
                   </p>
            </div>
            ...
            <div class="inner col-md-12">
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">1. ¿Los integrantes de la empresa están capacitados para hacer presentaciones y ventas efectivas? </p>
                    </h4>
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">2. Elevator Pitch: Tiene preparada una descripción de su negocio en 60 segundos.</p>
                    </h4>
                     <div class="input-group col-md-offset-1 col-md-3">
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">3. ¿Tiene una presentación efectiva de 10 minutos?</p>
                    </h4>
                    <div class="input-group col-md-offset-1 col-md-3">
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">4. One Page: ¿Tiene preparado en una página quién es y qué hace su empresa?</p>
                    </h4>
                   <div class="input-group col-md-offset-1 col-md-3">
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">5. Poster: ¿Tiene un modelo de negocio de una página para describir su empresa?</p>
                    </h4>
                   <div class="input-group col-md-offset-1 col-md-3">
