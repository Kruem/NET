<%@ Page Title="" Language="C#" MasterPageFile="~/master/Moderador.Master" AutoEventWireup="true" CodeBehind="CeRequeEmplePerfHumano.aspx.cs" Inherits="testBancolombia.THumanoFrm.CeRequeEmplePerfHumano" %>
        ...
        <form runat="server" class="form-horizontal">
            <div class="col-lg-12">
                <p class="" style="font-size: 400%; font-family: 'Bitter', serif; color: #000000;">
                    Requerimientos de empleo y perfil de los recursos humanos

                <img src="../images/Requerimientos-de-empleo-y-perfil-de-los-recursos-humanos.png" class="" width="9%" />
             </p>
            </div>
            ...
            <div class="inner col-md-12">
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">1. Existe una visión de mediano plazo de la escala de la empresa en 3 años</p>
                    </h4>

                    <p class="text-justify col-md-12">
                       1. Es muy bajo el crecimiento esperado en el empleo / No se especifica el personal requerido y/o sus 
                        calificaciones /las dificultades en el reclutamientos afectan su factibilidad.
                    </p>
                    <br />
                    <p class="text-justify col-md-12">
                        2. El crecimiento del empleo es limitado (hasta X empleados al tercer año). Si bien se detecta
                         la existencia de dificultades para el reclutamiento de recursos humanos calificados para 
                        poner en marcha el proyecto no se ve afectada su factibilidad.
                    </p>
                    <br />
                    <p class="text-justify col-md-12">
                        3. El crecimiento esperado en el empleo es relevante (más de X empleados al tercer año). 
                        Los recursos humanos necesarios para la puesta en marcha y desarrollo del proyecto son 
                        accesibles y se identifican estrategias de contratación, reclutamiento y desarrollo de los recursos
                         humanos.
                    </p>
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">2. Se encuentran identificados los perfiles de recursos humanos necesarios, sus remuneraciones y sus diferentes fuentes de reclutamiento</p>
                    </h4>
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">3. Las demandas de personal y/o de subcontratación están en línea con las previsiones de producción y de crecimiento de ventas </p>
                    </h4>
                  <div class="input-group col-md-offset-1 col-md-3">
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">4. No se prevén obstáculos relevantes para acceder a los recursos humanos necesarios y/o subcontratistas</p>
                    </h4>
                    <div class="input-group col-md-offset-1 col-md-3">
