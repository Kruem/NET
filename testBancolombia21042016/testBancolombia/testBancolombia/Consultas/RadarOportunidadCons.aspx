<%@ Page Title="" Language="C#" MasterPageFile="~/master/Consulta.Master" AutoEventWireup="true" CodeBehind="RadarOportunidadCons.aspx.cs" Inherits="testBancolombia.Consultas.RadarOportunidadCons" %>
                                    ...
                                    <table id="tresult" class="table table-condensed">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="text-center">                                                    
                                                    <h5><asp:Label ID="lblcalifT" runat="server" Text=""></asp:Label></h5>
                                                <td class="text-center">
