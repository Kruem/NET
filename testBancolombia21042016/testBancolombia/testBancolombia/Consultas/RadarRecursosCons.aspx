<%@ Page Title="" Language="C#" MasterPageFile="~/master/Consulta.Master" AutoEventWireup="true" CodeBehind="RadarRecursosCons.aspx.cs" Inherits="testBancolombia.Consultas.RadarRecursosCons" %>
                    ...
                    <div class="col-md-12 inner">
                        <div class="row">
                            <div class="col-md-12 text-box">
                                <h2><small>Resultados Recursos</small></h2>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <table id="tresult" class="table table-condensed">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-left"><h5>Antecedentes de financiación</h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblIdealaf" runat="server" Text=""></asp:Label></h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblcalif1" runat="server" Text=""></asp:Label></h5></td>
                                                <td>
                                                   <h5> <asp:Label ID="lblRealaf" runat="server" Text=""></asp:Label></h5></td>
                                                
                                            </tr>
                                            <tr>
                                                <td class="text-left"><h5>Información económica y financiera actual</h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblIdealief" runat="server" Text=""></asp:Label></h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblcalif2" runat="server" Text=""></asp:Label></h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblRealief" runat="server" Text=""></asp:Label></h5></td>
                                                
                                            </tr>
                                            <tr>
                                                <td class="text-left"><h5>Proyección Financiera</h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblIdealpf" runat="server" Text=""></asp:Label></h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblcalif3" runat="server" Text=""></asp:Label></h5></td>
                                                <td>
                                                <h5><asp:Label ID="lblRealpf" runat="server" Text=""></asp:Label></h5></td>
                                                </tr>
                                            <tr>
                                                <td class="text-left"><h5>Proyección Económica</h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblIdealpe" runat="server" Text=""></asp:Label></h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblcalif4" runat="server" Text=""></asp:Label></h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblRealpe" runat="server" Text=""></asp:Label></h5></td>
                                                
                                            </tr>
                                            <tr>
                                                <td class="text-left"><h5>Fuentes de financiación futura</h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblIdealfff" runat="server" Text=""></asp:Label></h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblcalif5" runat="server" Text=""></asp:Label></h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblRealfff" runat="server" Text=""></asp:Label></h5></td>
                                                
                                            </tr>
                                            <tr>
                                                <td class="text-left"><h5>Aliados claves</h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblIdealac" runat="server" Text=""></asp:Label></h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblcalif6" runat="server" Text=""></asp:Label></h5></td>
                                                <td>
                                                    <h5><asp:Label ID="lblRealac" runat="server" Text=""></asp:Label></h5></td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="js" runat="server">
    ...
    <script>    
        $(document).ready(function () {
            ...
            ide1 = $('#' + '<%= lblIdealaf.ClientID %>').text();
            ide2 = $('#' + '<%= lblIdealief.ClientID %>').text();
            ide3 = $('#' + '<%= lblIdealpf.ClientID %>').text();
            ide4 = $('#' + '<%= lblIdealpe.ClientID %>').text();
            ide5 = $('#' + '<%= lblIdealfff.ClientID %>').text();
            ide6 = $('#' + '<%= lblIdealac.ClientID %>').text();
            ...
            real1 = $('#' + '<%= lblRealaf.ClientID %>').text();
            real2 = $('#' + '<%= lblRealief.ClientID %>').text();
            real3 = $('#' + '<%= lblRealpf.ClientID %>').text();
            real4 = $('#' + '<%= lblRealpe.ClientID %>').text();
            real5 = $('#' + '<%= lblRealfff.ClientID %>').text();
            real6 = $('#' + '<%= lblRealac.ClientID %>').text();
