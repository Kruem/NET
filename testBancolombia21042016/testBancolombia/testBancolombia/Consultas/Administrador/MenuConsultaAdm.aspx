<%@ Page Title="" Language="C#" MasterPageFile="~/master/ConsultasAdmin.Master" AutoEventWireup="true" CodeBehind="MenuConsultaAdm.aspx.cs" Inherits="testBancolombia.Consultas.Administrador.MenuConsultaAdm" %>
                ...
                <div class="col-md-offset-3" id="page">
                    ...
                    <div class="dashboard">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="span6 ">
                                    <a href="../../Administrador/indexAdm.aspx" class="btn btn-info btn-lg" style="font-family: 'Roboto Condensed', sans-serif; border-color: #F37121; color: #F37121;">
