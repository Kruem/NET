<%@ Page Title="" Language="C#" MasterPageFile="~/master/ConsultasAdmin.Master" AutoEventWireup="true" CodeBehind="conOportunidadAdm.aspx.cs" Inherits="testBancolombia.Consultas.Administrador.conOportunidadAdm" %>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-offset-0 table-responsive text-left" style="height: 300px; overflow: scroll;">
                                        ...
                                        <asp:GridView ID="gvEmpresas" runat="server" CssClass="table table-bordered table-condensed" HeaderStyle-CssClass="label-warning text-center"
                                            AutoGenerateColumns="false" DataKeyNames="idEmpresResultCAN">
                                            <Columns>
                                                <asp:BoundField DataField="nombreEmpresaApps" HeaderText="Nombre" SortExpression="nombreEmpresaApps"></asp:BoundField>
                                                <asp:BoundField DataField="fechaResultCAN" HeaderText="Fecha Prueba" SortExpression="fechaResultCAN"></asp:BoundField>
                                                <asp:TemplateField HeaderText="<i class='glyphicon glyphicon-ok'></i>">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="rbSelect" Text="Check" GroupName="rbSelect" AutoPostBack="true" runat="server"
                                                            OnClick="rbSelect_Click" CommandArgument='<%# Eval("idEmpresResultCAN") + " , " + Eval("fechaResultCAN") %>' ><i class='glyphicon glyphicon-ok'></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-3 col-md-offset-9">
                                    <div class="">
                                        <a href="MenuConsultaAdm.aspx" class="btn btn-info btn-lg">
