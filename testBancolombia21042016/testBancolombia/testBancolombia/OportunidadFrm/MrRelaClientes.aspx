<%@ Page Title="" Language="C#" MasterPageFile="~/master/Moderador.Master" AutoEventWireup="true" CodeBehind="MrRelaClientes.aspx.cs" Inherits="testBancolombia.OportunidadFrm.MrRelaClientes" %>
    ...
    <div class="container-fluid backg" id="page-top">
        <form runat="server" class="form-horizontal">
            <div class="col-lg-12">
                ...
                <img src="../images/Relación-con-los-clientes.png" class="" width="9%" />
                </p>
            </div>
           ...
           <div class="inner col-md-12">
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">1. ¿La empresa tiene estructurado un plan de mercadeo?</p>
                    </h4>
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">2. ¿Sabe a qué clientes le va llegar con su plan de mercadeo? </p>
                    </h4>
                    <div class="input-group col-md-offset-1 col-md-2">
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">3. ¿La empresa cuenta con un proceso de administración de las relaciones con los clientes (CRM)?  </p>
                    </h4>
                    <div class="input-group col-md-offset-1 col-md-2">
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">4. ¿Tiene cuantificado el costo de las relaciones con sus clientes? </p>
                    </h4>
                    <div class="input-group col-md-offset-1 col-md-2">
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">5. ¿Tiene identificada las actividades claves que permitan fortalecer la relación con los clientes? </p>
                    </h4>
                    <div class="input-group col-md-offset-1 col-md-2">
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">6. ¿Tiene cuantificado el % de quejas y reclamos de sus clientes?  </p>
                    </h4>
                    <div class="input-group col-md-offset-1 col-md-2">
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">7. ¿La empresa ha realizado encuestas comerciales con potenciales clientes? </p>
                    </h4>
                    <div class="input-group col-md-offset-1 col-md-2">
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">8. ¿La empresa ha realizado encuestas comerciales con los clientes actuales?   </p>
                    </h4>
                     <div class="input-group col-md-offset-1 col-md-2">
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">9. ¿Tiene la empresa identificados los procesos que interaccionan de manera directa con el cliente (mercadeo, ventas, logística, servicio postventa)? </p>
                    </h4>
                    <div class="input-group col-md-offset-1 col-md-2">
