...
{
    public partial class InnoGeneConceptos : System.Web.UI.Page
    {
        DataSet dsSession = new DataSet();
        DataSet ds = new DataSet();
        DataSet ds2 = new DataSet();
        tblResultOGeneracionNuevosConceptos oEgnc = new tblResultOGeneracionNuevosConceptos();
        CRtblResultOGNC oRgnc = new CRtblResultOGNC();
        ...
        protected void btnguargar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    if (ddl1 == 1)
                    {
                        oEgnc.result1GNC = (div * 2).ToString();
                        total = total + (div * 2);
                    }
                    else
                    {
                        if (ddl1 == 2)
                        {
                            oEgnc.result1GNC = (div * 3).ToString();
                            total = total + (div * 3);
                        }
                        else
                        {
                            if (ddl1 == 3)
                            {
                                oEgnc.result1GNC = prcInd.ToString();
                                total = total + prcInd;
                            }
                        }
                    }
                ...
                else
                {
                    if (ddl2 == 1)
                    {
                        oEgnc.result2GNC = (div * 2).ToString();
                        total = total + (div * 2);
                    }
                    else
                    {
                        if (ddl2 == 2)
                        {
                            oEgnc.result2GNC = (div * 3).ToString();
                            total = total + (div * 3);
                        }
                        else
                        {
                            if (ddl2 == 3)
                            {
                                oEgnc.result2GNC = prcInd.ToString();
                                total = total + prcInd;
                            }
                        }
                    }
                ...
                else
                {
                    if (ddl3 == 1)
                    {
                        oEgnc.result3GNC = (div * 2).ToString();
                        total = total + (div * 2);
                    }
                    else
                    {
                        if (ddl3 == 2)
                        {
                            oEgnc.result3GNC = (div * 3).ToString();
                            total = total + (div * 3);
                        }
                        else
                        {
                            if (ddl3 == 3)
                            {
                                oEgnc.result3GNC = prcInd.ToString();
                                total = total + prcInd;
                            }
                        }
                    }
                ...
                else
                {
                    if (ddl4 == 1)
                    {
                        oEgnc.result4GNC = (div * 2).ToString();
                        total = total + (div * 2);
                    }
                    else
                    {
                        if (ddl4 == 2)
                        {
                            oEgnc.result4GNC = (div * 3).ToString();
                            total = total + (div * 3);
                        }
                        else
                        {
                            if (ddl4 == 3)
                            {
                                oEgnc.result4GNC = prcInd.ToString();
                                total = total + prcInd;
                            }
                        }
                    }
                ...
                else
                {
                    if (ddl5 == 1)
                    {
                        oEgnc.result5GNC = (div * 2).ToString();
                        total = total + (div * 2);
                    }
                    else
                    {
                        if (ddl5 == 2)
                        {
                            oEgnc.result5GNC = (div * 3).ToString();
                            total = total + (div * 3);
                        }
                        else
                        {
                            if (ddl5 == 3)
                            {
                                oEgnc.result5GNC = prcInd.ToString();
                                total = total + prcInd;
                            }
                        }
                    }
                ...
                oEgnc.fechaResultGNC = fecha;
                oEgnc.totalResultGNC = Convert.ToString(total);
                oEgnc.observaciones = txtObservaciones.Text.Trim();

                if (dsSession.Tables[0].Rows.Count != 0)
                {
                    oEgnc.idEmpresResultGNC = (int)dsSession.Tables[0].Rows[0]["idEmpresaDef"];
                }

                if (oRgnc.CrearoGeneraNuevosConcept(oEgnc))
                {
