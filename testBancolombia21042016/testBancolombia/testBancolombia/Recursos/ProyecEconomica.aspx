<%@ Page Title="" Language="C#" MasterPageFile="~/master/Moderador.Master" AutoEventWireup="true" CodeBehind="ProyecEconomica.aspx.cs" Inherits="testBancolombia.Recursos.ProyecEconomica" %>
    ...
    <div class="container-fluid backg" id="page-top">
        <form runat="server" class="form-horizontal">
            <div class="col-md-12">
                ...
                <img src="../images/Proyección-económica.png" class="" width="9%" />
                </p>
            </div>
            ...
            <div class="inner col-md-12">
                ...
                <div class="row">
                    ...
                    <p class="text-justify col-md-12">
                        1. No se suministra información / La rentabilidad proyectada es menor al 10% 
                        / No se precisa de qué manera se financiará la empresa hasta alcanzar el punto de equilibrio / La demora 
                        en recuperar la inversión supera los 5 años.
                    </p>
                    <p class="text-justify col-md-12">
                        2. La rentabilidad proyectada está dentro del rango 10%-25% anual. 
                        Alcanza el punto de equilibrio operativo antes de los 18 meses de operación.
                         Recupera la inversión antes de los 4 años. El crecimiento anual de las ventas es importante.
                    </p>
                    <p class="text-justify col-md-12">
                        3.La rentabilidad proyectada supera el 25% anual. Alcanza el punto de equilibrio
                          operativo antes de los 18 meses de operación. Recupera la inversión antes de los
                          3 años. El crecimiento promedio anual de las ventas es muy importante.
                    </p>                    
                ...
                <div class="row">
                    <h4>
                        <p class="text-justify label-control">6. La La sensibilidad del proyecto frente a una disminución en las ventas es baja.</p>
                    </h4>
                    <div class="input-group col-md-offset-1 col-md-3">
