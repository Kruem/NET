<%@ Page Title="" Language="C#" MasterPageFile="~/P_Master/CYC.Master" AutoEventWireup="true" CodeBehind="GCompraAdm.aspx.cs" Inherits="SisGest2013Full.CYC.GCompraAdm" %>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <asp:TextBox ID="txtfecha" class="form-control" placeholder="dd/mm/yyyy" onchange="CalcularGrafico();"
