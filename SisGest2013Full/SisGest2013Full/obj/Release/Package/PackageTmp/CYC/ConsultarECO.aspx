<%@ Page Title="" Language="C#" MasterPageFile="~/P_Master/CYC.Master" AutoEventWireup="true"
    CodeBehind="ConsultarECO.aspx.cs" Inherits="SisGest2013Full.CYC.ConsultarECO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Body" runat="server">
                ...
                <div class="row">
                    ...
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            ...
                            <div id="collapse1" class="panel-collapse collapse table">
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive col-lg-12" style="height: 400px; overflow: scroll;">
                                        ...
                                        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered f2" runat="server"
                                            AutoGenerateColumns="False" AllowPaging="True" PagerSettings-Mode="NextPreviousFirstLast"
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive col-lg-12" style="height: 400px; overflow: scroll;">
                                        ...
                                        <asp:GridView ID="GridView3" CssClass="table table-striped table-bordered" runat="server"
                                            ...
                                            PagerSettings-FirstPageText="&nbsp;Inicio&nbsp;" PagerSettings-LastPageText="&nbsp;Fin&nbsp;"
                                            PagerSettings-NextPageText="&nbsp;Siguiente&nbsp;" PagerSettings-PreviousPageText="&nbsp;Previo&nbsp;"
                                            PagerSettings-Position="TopAndBottom" DataSourceID="ObjectDataSource2">
                                            <PagerSettings FirstPageText="&#160;Inicio&#160;" LastPageText="&#160;Fin&#160;"
                                                Mode="NextPreviousFirstLast" NextPageText="&#160;Siguiente&#160;" Position="TopAndBottom"
                                                PreviousPageText="&#160;Previo&#160;"></PagerSettings>
                                            <Columns>
                                    ...
                                    <div class="col-lg-10 col-lg-offset-1">
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-offset-4">
                                                ...
                                                <br />
                                                <asp:Button ID="btnconsulta" class="btn btn-danger " Text="CONSULTA" runat="server"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-offset-2" style="height: 400px; overflow: scroll;">
                                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" EmptyDataText="No files uploaded"
                                                        ...
                                                        <Columns>
                                                            <asp:BoundField DataField="Text" HeaderText="ARCHIVOS" ReadOnly="True" />
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
   ...
   <img alt="Descargar" src="../img/download-icon.jpg" height="30" width="30"/>
                                                ...
                                                <asp:Label ID="lblmensaje" CssClass="h3 label-warning text-danger" runat="server"
                                                    Text=""></asp:Label>
                                            </div>
                                        </div>
                                    </div>
