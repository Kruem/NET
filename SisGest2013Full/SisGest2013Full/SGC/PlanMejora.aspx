<%@ Page Title="" Language="C#" MasterPageFile="~/P_Master/SGC.Master" AutoEventWireup="true" CodeBehind="PlanMejora.aspx.cs" Inherits="SisGest2013Full.SGC.PlanMejora" %>
            ...
            <div class="box" style="border-radius:10px;">
                <form id="Form1" runat="server">
                    <div class="table-responsive">
                        <h2 class="text-center">Plan de Mejora</h2>
